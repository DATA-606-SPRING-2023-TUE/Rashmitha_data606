...
#### depending on all the above parameter requirments each column can be divided into group of 5 categories as good average and bad 

### steps followed
1. loading the data and analysing it
2. processing
3. modeling
4. choosing the best model with better accuracy
5. deploying the model into web page using streamlit
